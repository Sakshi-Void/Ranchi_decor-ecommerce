...
//                 <div className="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
//                   <div className="py-1">
//                     <Link to="/products/flooring" className="block px-4 py-2 text-sm text-gray-700 hover:bg-red-50">Flooring Solutions</Link>
//                     <Link to="/products/carpets" className="block px-4 py-2 text-sm text-gray-700 hover:bg-red-50">Carpets & Rugs</Link>
//                     <Link to="/products/wallpapers" className="block px-4 py-2 text-sm text-gray-700 hover:bg-red-50">Wallpapers</Link>
//                     <Link to="/products/blinds" className="block px-4 py-2 text-sm text-gray-700 hover:bg-red-50">Window Blinds</Link>
//                     <Link to="/products/panels" className="block px-4 py-2 text-sm text-gray-700 hover:bg-red-50">Decorative Panels</Link>
//                     <Link to="/products/greenery" className="block px-4 py-2 text-sm text-gray-700 hover:bg-red-50">Artificial Greenery</Link>
//                   </div>
//                 </div>
//               </div>
//               <Link to="/gallery" className="text-gray-700 hover:text-red-500 transition-colors">Gallery</Link>
